<div x-data="{ type: 'all' }" class="flex flex-col transition-all h-full overflow-hidden">
    {{-- Header --}}
    <div class=" px-3 z-10 bg-white sticky top-0 w-full py-2">
    ...
    <div class="overflow-y-scroll overflow-hidden grow h-full relative" style="contain:content">
        ...
        <ul class="p-2 grid w-full spacey-y-2">
            <li class="py-3 hover:bg-gray-100 rounded-2xl dark:hover:bg-gray-100/70 transition-colors duration-150 flex gap-4 relative w-full cursor-point px-2">
                ...
                <aside class="grid grid-cols-12 w-full">
                    <a href="" class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                        ...
                        <div class="flex items-center gap-x-2">
                            ...
                            {{-- unread count --}}
                            <span class="font-bold p-px px-2 text-xs shrink-0 rounded-full bg-red-500 text-white">5</span>
                        </div>
                    </a>
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <div class="w-full p-1">
                                    <button class="flex items-center gap-3 w-full px-4 py-2 textsm leading-5 text-white hover:bg-gray-600 transition-all duration-150 ease-in-out focus:outline-none focus:bg-gray-600">
                                        <span>
